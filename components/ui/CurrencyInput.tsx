    ...
    return (
      <div className="w-full">
        ...
        <div className="relative">
          <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600 font-black text-sm pointer-events-none">
            {currency}
          </div>
          ...
          <input
            ...
            className={cn(
              'w-full bg-white border-2 rounded-[1.2rem] pl-16 pr-6 py-4 text-sm font-black text-black outline-none transition-all shadow-sm',
