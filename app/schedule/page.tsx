  ...
  return (
    <div className="max-w-7xl mx-auto pb-20">
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          <h1 className="text-xl md:text-2xl font-bold tracking-tight text-blue-600">Schedule</h1>
                    ...
                    <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} key={ev.id} className="bg-white/5 p-3 rounded-2xl border border-white/[0.05] hover:bg-white/[0.08] transition-all group">
                      <div className="flex justify-between items-start gap-3">
                        <div className="flex gap-3 items-center min-w-0">
                          <div className={`p-2 rounded-xl shrink-0 shadow-sm ${ev.type === 'task' ? 'bg-blue-500/20 text-blue-400' :
